        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="mt-8 sm:mt-10 lg:mt-12 text-center">
            <a
              ...
              className="inline-block text-base sm:text-lg text-warm-brown hover:underline font-medium transition-colors duration-200 hover:text-warm-brown-dark focus:text-warm-brown-dark"
            >
